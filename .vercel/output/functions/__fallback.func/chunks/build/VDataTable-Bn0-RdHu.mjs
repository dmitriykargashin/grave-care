import { toRefs, toRef, computed, createVNode, mergeProps, createElementVNode, Fragment, ref, watchEffect, capitalize, provide, toValue, watch, shallowRef, normalizeStyle, normalizeClass, toRaw, inject, createTextVNode, withModifiers, toDisplayString, nextTick } from 'vue';
import { A as genericComponent, z as propsFactory, af as provideDefaults, a0 as useRender, a7 as omit, a3 as VDivider, B as useProxiedModel, L as useLocale, al as getCurrentInstance, $ as wrapInArray, aq as isPrimitive, aa as deepEqual, au as useLoader, _ as useBackgroundColor, ae as useDisplay, av as LoaderSlot, az as pick, C as provideTheme, E as useDensity, ao as convertToUnit, Z as IconValue, ar as getObjectValueByPath, as as isEmpty, am as clamp, ad as useRtl, ag as useResizeObserver, ah as createRange, p as VBtn, aw as makeLoaderProps, ax as makeDisplayProps, X as makeDensityProps, an as defineFunctionalComponent, l as VChip, f as VIcon, ab as isOn, ac as callEvent, P as makeThemeProps, Q as makeTagProps, Y as makeComponentProps, ap as consoleError, aA as getPropertyFromItem, at as isObject, O as makeVariantProps, ai as makeSizeProps, R as makeRoundedProps, U as makeElevationProps, aj as makeBorderProps, ak as keyValues, ay as EventProp } from './server.mjs';
import { u as useFilter, f as makeFilterProps, V as VSelect, e as VCheckboxBtn } from './filter-CwhwF0wl.mjs';
...
//# sourceMappingURL=VDataTable-Bn0-RdHu.mjs.map
